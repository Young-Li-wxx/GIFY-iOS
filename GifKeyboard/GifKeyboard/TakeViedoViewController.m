//
//  TakeViedoViewController.m
//  GifKeyboard
//
//  Created by LouieShum on 3/24/16.
...
@interface TakeViedoViewController()<AVCaptureFileOutputRecordingDelegate>//视频文件输出代理
...
@implementation TakeViedoViewController
- (void)viewDidLoad{
    [super viewDidLoad];
