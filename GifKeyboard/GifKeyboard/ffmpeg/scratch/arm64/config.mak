...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-debug --disable-doc --enable-pic --extra-cflags='-arch arm64 -mios-version-min=6.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=6.0 -fembed-bitcode' --prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/arm64
prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/arm64
...
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=xcrun -sdk iphoneos clang
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
CFLAGS=  -arch arm64 -mios-version-min=6.0 -fembed-bitcode -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -arch arm64 -mios-version-min=6.0 -fembed-bitcode -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-version-min=6.0 -fembed-bitcode  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
