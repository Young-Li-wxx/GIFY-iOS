...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-debug --disable-doc --enable-pic --extra-cflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode' --extra-ldflags='-arch armv7 -mios-version-min=6.0 -fembed-bitcode' --prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/armv7
prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/armv7
...
SRC_PATH=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/ffmpeg-3.0
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Apple LLVM version 7.3.0 (clang-703.0.29)
ARCH=arm
INTRINSICS=neon
CC=xcrun -sdk iphoneos clang
CXX=g++
AS=gas-preprocessor.pl -arch arm -as-type apple-clang -- xcrun -sdk iphoneos clang
OBJCC=xcrun -sdk iphoneos clang
LD=xcrun -sdk iphoneos clang
DEPCC=xcrun -sdk iphoneos clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl -arch arm -as-type apple-clang -- xcrun -sdk iphoneos clang
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC -DZLIB_CONST
CFLAGS=  -arch armv7 -mios-version-min=6.0 -fembed-bitcode -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -arch armv7 -mios-version-min=6.0 -fembed-bitcode -march=armv7-a -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch armv7 -mios-version-min=6.0 -fembed-bitcode  -march=armv7-a -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework QuartzCore -framework CoreVideo -liconv -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
