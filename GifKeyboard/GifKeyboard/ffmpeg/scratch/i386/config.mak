...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=i386 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-debug --disable-doc --enable-pic --extra-cflags='-arch i386 -mios-simulator-version-min=6.0' --extra-ldflags='-arch i386 -mios-simulator-version-min=6.0' --prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/i386
prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/i386
...
CFLAGS=  -arch i386 -mios-simulator-version-min=6.0 -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -arch i386 -mios-simulator-version-min=6.0 -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch i386 -mios-simulator-version-min=6.0  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
SHFLAGS=-dynamiclib -Wl,-single_module -Wl,-install_name,$(SHLIBDIR)/$(SLIBNAME_WITH_MAJOR),-current_version,$(LIBVERSION),-compatibility_version,$(LIBMAJOR) -Wl,-read_only_relocs,suppress
ASMSTRIPFLAGS= -x
YASMFLAGS=-f macho  -DPIC -DPREFIX
BUILDSUF=
PROGSSUF=
