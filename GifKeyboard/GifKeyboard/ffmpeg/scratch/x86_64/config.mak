...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-debug --disable-doc --enable-pic --extra-cflags='-arch x86_64 -mios-simulator-version-min=6.0' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=6.0' --prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/x86_64
prefix=/Users/Shum/workspace/code/iu/keyboard-ios/GifKeyboard/GifKeyboard/ffmpeg/thin/x86_64
...
CFLAGS=  -arch x86_64 -mios-simulator-version-min=6.0 -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -arch x86_64 -mios-simulator-version-min=6.0 -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch x86_64 -mios-simulator-version-min=6.0  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
